        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
              <div className="flex items-center gap-2 text-xs font-medium text-zinc-200 bg-zinc-900/80 p-2.5 rounded-xl border border-zinc-800">
              ...
              <div className="flex items-center gap-2 text-xs font-medium text-zinc-200 bg-zinc-900/80 p-2.5 rounded-xl border border-zinc-800 col-span-2 sm:col-span-1">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="px-6 py-3.5 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold text-sm rounded-xl shadow-lg shadow-emerald-500/25 flex items-center gap-2 transition-all hover:scale-105 active:scale-95"
              >
              ...
              <button
                ...
                className="px-5 py-3.5 bg-zinc-900 hover:bg-zinc-800 text-amber-300 border border-amber-500/40 font-semibold text-sm rounded-xl flex items-center gap-2 transition-colors"
              >
              ...
              <button
                ...
                className="px-4 py-3.5 bg-zinc-900 hover:bg-zinc-800 text-zinc-300 border border-zinc-700 font-medium text-sm rounded-xl flex items-center gap-2 transition-colors"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-zinc-900/90 rounded-2xl border border-zinc-800 p-6 shadow-2xl backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
                ...
                <span className="text-xs text-zinc-400 font-mono">blackaccworld.com</span>
              </div>
              ...
              <div className="my-4 space-y-2.5">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-white">Telegram Support</div>
                      <div className="text-xs text-sky-300 font-mono">@{CONTACT_INFO.telegramUser}</div>
                    </div>
                  </div>
                  <span className="text-xs font-bold px-2 py-1 bg-sky-500/20 rounded-lg text-sky-200">
                    Chat Now
                  </span>
                </a>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-white">WhatsApp VIP Support</div>
                      <div className="text-xs text-emerald-300 font-mono">{CONTACT_INFO.whatsappNumber}</div>
                    </div>
                  </div>
                  <span className="text-xs font-bold px-2 py-1 bg-emerald-500/20 rounded-lg text-emerald-200">
                    Message
                  </span>
                </a>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 pt-3 border-t border-zinc-800 text-center">
                <div className="bg-zinc-950/60 p-2 rounded-xl border border-zinc-800">
                  <div className="text-base font-black text-emerald-400 font-mono">10,000+</div>
                  <div className="text-[10px] text-zinc-400">Orders Delivered</div>
                </div>
                <div className="bg-zinc-950/60 p-2 rounded-xl border border-zinc-800">
                  <div className="text-base font-black text-white font-mono">99.8%</div>
                  <div className="text-[10px] text-zinc-400">Retention Rate</div>
                </div>
                <div className="bg-zinc-950/60 p-2 rounded-xl border border-zinc-800">
                  <div className="text-base font-black text-amber-400 font-mono">12 Coins</div>
                  <div className="text-[10px] text-zinc-400">Instant Crypto</div>
                </div>
              </div>
            </div>
          </div>
